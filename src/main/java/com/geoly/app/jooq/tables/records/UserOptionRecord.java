...
public class UserOptionRecord extends UpdatableRecordImpl<UserOptionRecord> implements Record6<Integer, Byte, Byte, Byte, Integer, Integer> {

    private static final long serialVersionUID = 910093548;
     ...
     */
    public void setMapTheme(Byte value) {
        set(2, value);
    }
     ...
     */
    @Override
    public UserOptionRecord value3(Byte value) {
        setMapTheme(value);
        return this;
    }
     ...
     */
    @Override
    public UserOptionRecord values(Integer value1, Byte value2, Byte value3, Byte value4, Integer value5, Integer value6) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public UserOptionRecord(Integer id, Byte darkMode, Byte mapTheme, Byte privateProfile, Integer languageId, Integer userId) {
        super(UserOption.USER_OPTION);
