...
public class QuestRecord extends UpdatableRecordImpl<QuestRecord> implements Record9<Integer, Byte, Timestamp, Byte, String, Byte, Byte, Integer, Integer> {

    private static final long serialVersionUID = 1672882034;
     ...
     */
    @Override
    public Row9<Integer, Byte, Timestamp, Byte, String, Byte, Byte, Integer, Integer> fieldsRow() {
     ...
     */
    @Override
    public Row9<Integer, Byte, Timestamp, Byte, String, Byte, Byte, Integer, Integer> valuesRow() {
     ...
     */
    @Override
    public QuestRecord value7(Byte value) {
     ...
     */
    @Override
    public QuestRecord value8(Integer value) {
        setCategoryId(value);
        return this;
    }
     ...
     */
    @Override
    public QuestRecord values(Integer value1, Byte value2, Timestamp value3, Byte value4, String value5, Byte value6, Byte value7, Integer value8, Integer value9) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public QuestRecord(Integer id, Byte active, Timestamp createdAt, Byte daily, String description, Byte difficulty, Byte privateQuest, Integer categoryId, Integer userId) {
        super(Quest.QUEST);
